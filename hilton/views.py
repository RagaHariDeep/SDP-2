...
from superadmin.models import Rooms,superadminlogin
...
def mybookings(request):
    if request.session.get("email",None):
        ...
        return render(request,"mybookings.html",{"dineinbookings":dineinbookings,"bookrooms":bookrooms,"totalbookroom":totalbookroom})
    else:
        return redirect("loginpage")
